...
//if boolean "extensionIsOn" false, then hide this: 
  ...
  Swal.fire({
    ...
    Swal.fire({
      text: 'How many hours would you like to be producktive for?',
      input: 'number',
      inputAttributes: {
         min: .5, 
         max: 24,
      ...
      if (result.value) {
        ...
        hours = amount
        console.log(hours)
        Swal.fire(amount + ' hours of producktivity, starting from now!')
        //pass value of amoßunt to timer function (should be in alert), receive value in alert
      }
    })
  })
